...
--
-- Host: localhost
-- Generation Time: Feb 19, 2016 at 09:06 AM
...
CREATE TABLE IF NOT EXISTS `gas_gas_master_lookup` (
  ...
  `type` tinyint(2) DEFAULT NULL COMMENT 'loại trong lookup, trong sổ quỹ thì 1: thu, 2: chi',
  `type_lookup` tinyint(2) DEFAULT NULL COMMENT '1: brand of product, 2: update sau nếu phát sinh',
...
(2, 1, '123', '', '', '', 1, NULL, '2016-02-17 16:27:55'),
(3, 1, '123', '', '', '', 1, NULL, '2016-02-17 16:28:02'),
...
CREATE TABLE IF NOT EXISTS `gas_murad_news` (
  ...
  `feature_image` tinyint(1) unsigned DEFAULT NULL,
  `name_vi` varchar(350) DEFAULT NULL,
  `slug` varchar(450) DEFAULT NULL,
  `content` text,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(2, 'muradvn', '123123', '4297f44b13955235245b2497399d7a93', 'admin', '0', 'admin', NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 0, '2012-06-18 17:00:00', '2016-02-18 20:41:49', '::1', 2, 1, 1, '', '0909999999', 'f4dce90a253a15ce58b2f1ec7dbfbf67', 0, 0, NULL, 0, 0, '', NULL, NULL, 'ngockien12312@yahoo.com', '', 'admin 0909999999');
