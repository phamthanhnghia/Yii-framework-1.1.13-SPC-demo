...
<h1>Phân Quyền Cho User: <?php echo $mUser->code_account." - $mUser->username - ".$mUser->first_name ?></h1>
...
<div class="form form_fix_submit">
    ...
    <div class="row buttons" style="padding-left: 250px;">
        ...
        <a class="btn_cancel" onclick="confirmResetPermission(this); return false;" href="<?php echo Yii::app()->createAbsoluteUrl('admin/rolesAuth/resetRoleCustomOfUser', array('id'=>$_GET['id'])) ;?>">Reset toàn bộ quyền của nhân viên này</a> 
