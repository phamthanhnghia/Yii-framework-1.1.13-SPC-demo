<?php $cmsFormater = new CmsFormatter(); 
    ...
    $CanReply = true;
    if($data->status == GasTickets::STATUS_CLOSE )
    {
        $CanReply = false;
    }    
?>
<li class="ticket">
        <div class="content">
            ...
            <div class="actions">
                ...
                <?php endif;?>
                <a class="view collapsed" href="#ticket-<?php echo $data->id;?>" title="Xem ticket">View</a>
                <!--- for delete button --> 
        ...
        <div id="ticket-<?php echo $data->id;?>" class="in collapse display_none" style="">
            <div class="post_reply post_reply<?php echo $data->id;?>" data_class="post_reply<?php echo $data->id;?>">                
                ...
                <?php
                    ...
                    if( $CanReply && ( $data->process_status == GasTickets::PROCESS_STATUS_FINISH ||
                ...
                <?php  // nếu ticket status là new và không phải của đại lý tạo thì dc phép pick ticket này
                    elseif($data->process_status == GasTickets::PROCESS_STATUS_NEW &&
                        $data->uid_login != $uidLogin && $data->status == GasTickets::STATUS_OPEN
                        ):?>
                    <div class="styled-form">
