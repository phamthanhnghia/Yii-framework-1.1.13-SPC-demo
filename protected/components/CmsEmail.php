...
class CmsEmail
{
    ...
    {
//        self::_setTestEmail($data, 'verzdev1@gmail.com');
    ...
    /**
     * @Author: ANH DUNG Dec 07, 2015
     * @Todo: để send mail với 1 nội dung tùy chọn trong code php, không cần lấy ở email template 
     * @param: $sSubject tiêu đề email
     * @param: $sBody : nội dung email
     * @param: $sTo dung.nt@verzdesign.com.sg
     */
    public static function AdminSendAnyContent($sSubject, $sBody, $sTo)
    {
        $data = array(
            'subject'=>$sSubject,
            'params'=>array(
