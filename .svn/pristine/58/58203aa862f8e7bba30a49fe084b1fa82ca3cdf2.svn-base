...
class GaswardController extends AdminController 
{
	/**
	...
	{
            $this->pageTitle = 'Tạo Mới Phường Xã';
                try
                {
	...
	{
            $this->pageTitle = 'Cập Nhật Phường Xã';
                try
                {
	...
	{
            $this->pageTitle = 'Danh Sách Phường Xã';
                try
                {
		$model=new GasWard('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GasWard']))
			$model->attributes=$_GET['GasWard'];
	...
	public function loadModel($id)
	{
                try
                {
		$model=GasWard::model()->findByPk($id);
		if($model===null)
                {
	...
	protected function performAjaxValidation($model)
	{
                try
                {
		if(isset($_POST['ajax']) && $_POST['ajax']==='gas-ward-form')
		{
