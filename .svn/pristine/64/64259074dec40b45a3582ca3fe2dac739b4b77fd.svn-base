...
class UsersActionsController extends AdminController
{
	/**
...
//			
	...
	{
		$model=new UsersActions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsersActions']))
			$model->attributes=$_GET['UsersActions'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='users-actions-form')
		{
