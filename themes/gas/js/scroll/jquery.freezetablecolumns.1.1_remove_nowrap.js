...
(function( $ ) {
  $.fn.freezeTableColumns = function(options) {
    options = initOptions(options);
		...
		main_div.append(
//		  '<div id="' + main_id + '-row1" style="white-space: nowrap;">' + // Jun 28, 2014 ANH DUNG REMOVE
		  '<div id="' + main_id + '-row1" style="">' + 
      ...
      '<div id="' + main_id + '-region2" style="display: inline-block; vertical-align: top; width: 5px; overflow-x: hidden; overflow-y: scroll;"><div></div></div>' + 
		...
		main_div.append(
//      '<div id="' + main_id + '-row2"  style="white-space: nowrap;">' + // Jun 28, 2014 ANH DUNG REMOVE
      '<div id="' + main_id + '-row2"  style="">' +
